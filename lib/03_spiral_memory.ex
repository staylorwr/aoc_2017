defmodule SpiralMemory do
  ...
  1.  Count the manhattan distance steps back to 1 for a given value
  """

  @doc """
  Gives the manhattan distance back to 1
  ...
  As we spiral outwards, set the value of each cell as the sum of values of its
  neighbors including diagonals.  The starting value is 1. This is returned as a
  map %{coordinate => value}.  The enumeration halts after a value that's
...
defmodule Spiral do
  @moduledoc """
  Generates cartesian coordinates in a spiral

  The first cell is in the center, going left, up, down, right, etc
