defmodule Spinlock do
  ...
  @doc """
  Return the value after the last inserted value, given spin length and
  number of spins

  ## Examples

      iex> value_after_last_inserted(3, 2017)
      638
  """
  @spec value_after_last_inserted(integer(), integer()) :: integer()
