defmodule StreamProcessing do
  @moduledoc """
  Stream Processing: Day 9

  We're given a stream of nested garbage groups.  A stream contains groups of
  groups.  The groups are delimited by curly braces.  Garbage is delimited by
  angle brackets.  Exclamation mark escapes the following character.

  Groups are scored.  The outermost group is scored 1.  Nested groups are scored
  one more then its parent group.
  ...
  @doc """
  Give the total score for input
